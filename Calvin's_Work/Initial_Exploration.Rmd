...
typeof(alcohol_summary)
```

# Density Ridges Graphs
## Using quality data
```{r, echo=FALSE, message=FALSE}
ggplot(wine_data) + geom_density_ridges(aes(x = volatile.acidity, y = Quality))

ggplot(wine_data) + geom_density_ridges(aes(x = alcohol, y = Quality))
